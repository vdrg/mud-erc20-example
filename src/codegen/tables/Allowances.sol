...
library Allowances {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "mytokenns", name: "Allowances", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d79746f6b656e6e730000000000416c6c6f77616e636573000000000000);
