...
library Balances {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "mytokenns", name: "Balances", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d79746f6b656e6e73000000000042616c616e6365730000000000000000);
