...
library TotalSupply {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "mytokenns", name: "TotalSupply", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d79746f6b656e6e730000000000546f74616c537570706c790000000000);
   ...
   * @notice Get totalSupply.
   */
  function get() internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get totalSupply.
   */
  function _get() internal view returns (uint256 totalSupply) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set totalSupply.
   */
  function set(uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set totalSupply.
   */
  function _set(uint256 totalSupply) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
