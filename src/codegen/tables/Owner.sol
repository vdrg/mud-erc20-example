...
library Owner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "mytokenns", name: "Owner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d79746f6b656e6e7300000000004f776e65720000000000000000000000);
   ...
   * @notice Get owner.
   */
  function get() internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get owner.
   */
  function _get() internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set owner.
   */
  function set(address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set owner.
   */
  function _set(address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
